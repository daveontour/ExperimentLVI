...
@Component({
  template: `
    ...
    <div class="modal-body" style="color:black" align="left">
      ...
      <tr><td><label>Start Time:&nbsp;</label></td><td>
      ...
      <tr><td><label>Flight Scheduled:&nbsp;</label></td><td>
      <input [ngxTimepicker]="picker5" [format]="24" class="gridinput"  id = "sto" style="height:25px;width:90px; font-size: 12px;">
